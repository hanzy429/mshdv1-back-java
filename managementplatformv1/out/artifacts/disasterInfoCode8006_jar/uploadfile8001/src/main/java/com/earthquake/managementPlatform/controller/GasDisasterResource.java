...
import com.earthquake.managementPlatform.mapper2.GasDisasterMapper;
...
public class GasDisasterResource {
    ...
    public PostVo gasDisasterAll(HttpServletRequest request)throws IOException {
        List<GasDisaster> gasDisaster = gasDisasterMapper.getAllGasDisaster();
        String json= JSON.toJSONString(gasDisaster);
