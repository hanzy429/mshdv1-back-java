...
import com.earthquake.managementPlatform.mapper2.CrackRecordMapper;
...
public class CrackRecordResource {
    ...
    public PostVo crackRecordAll(HttpServletRequest request)throws IOException {
        List<CrackRecord> crackRecord = crackRecordMapper.getAllCrackRecord();
        String json= JSON.toJSONString(crackRecord);
