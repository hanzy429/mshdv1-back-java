...
import com.earthquake.managementPlatform.mapper2.LandslideRecordMapper;
...
public class LandslideRecordResource {
    ...
    public PostVo landslideRecordAll(HttpServletRequest request)throws IOException {
        List<LandslideRecord> landslideRecord = landslideRecordMapper.getAllLandslideRecord();
        String json= JSON.toJSONString(landslideRecord);
