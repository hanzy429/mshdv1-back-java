...
import com.earthquake.managementPlatform.mapper2.OilDisasterMapper;
...
public class OilDisasterResource {
    ...
    public PostVo oilDisasterAll(HttpServletRequest request)throws IOException {
        List<OilDisaster> oilDisaster = oilDisasterMapper.getAllOilDisaster();
        String json= JSON.toJSONString(oilDisaster);
