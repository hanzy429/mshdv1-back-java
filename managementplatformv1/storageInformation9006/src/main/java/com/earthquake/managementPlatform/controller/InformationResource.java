...
//    }
    ...
    @GetMapping("/v1/singleDisasterInfo/{id}")
    public BasicEarthquakeInfo getDisasterInfoById(@PathVariable("id")String id){
        BasicEarthquakeInfo disasterInfo = basicEarthquakeInfoMapper.getDisasterInfoById(id);
        return disasterInfo;
    }
